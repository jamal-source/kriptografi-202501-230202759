...
def main():
    ...
    private_key = os.getenv('')  # Mengambil private key dari environment variable
    if not private_key:
        raise Exception("z4ueToiKjsxvQnA2N82p5lpYgHt2v58tDXvZ09Lb87V0fBFgATQ1vQ environment variable tidak diatur")  # Error jika private key tidak ada
