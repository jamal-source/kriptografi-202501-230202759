...
from brownie import network, accounts, TinyToken  # Import dari Brownie untuk jaringan, akun, dan kontrak
...
def main():
    ...
    # Menampilkan pesan deploy TinyToken
    print("Deploy TinyToken...")
    # Deploy TinyToken dengan supply awal
    initial_supply = 1000000 * 10**18  # 1 juta token dengan 18 desimal
